...
const EMAIL_REGEX = new RegExp(/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$/)
const ALPHABET_WITHSPACE_REGEX = new RegExp(/^[a-zA-Z ]+$/);
const ALPHABET_WITHSPACEANDNUMBER_REGEX = new RegExp(/^[a-zA-Z0-9 ]+$/);
...
const ET_ALPHABET_WITHSPACEANDNUMBER_REGEX = new RegExp(/^([ \u1200-\u137F0-9])+$/);
...
export {
  ...
  ALPHABET_WITHSPACEANDNUMBER_REGEX, ET_ALPHABET_WITHSPACEANDNUMBER_REGEX,
  EMAIL_REGEX
};
