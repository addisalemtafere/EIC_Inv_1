...
namespace EIC.Investment.API.Controllers
{
  ...
  public class LookupController : Controller
  {
    ...
    [HttpGet]
    [Route("api/Lookup/ByParent/{id}")]
    public async Task<List<Lookups>> GetLookupsByParent(int id, int page = -1, int pageSize = 10)
    {
      return await _lookupRepo.GetLookupsByParent(id, page, pageSize);
    }
