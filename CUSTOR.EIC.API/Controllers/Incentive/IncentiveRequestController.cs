...
namespace CUSTOR.EICOnline.API.Controllers.Incentive
{
  ...
  public class IncentiveRequestController : Controller
  {
    ...
    [HttpGet]
    [Route("api/IncentiveRequest/ByServiceAppId/{id:int}/{lang}")]
    public async Task<IEnumerable<IncentiveRequestsDTO>> GetIncentiveRequestsByServiceAppId(string lang, int id,
      int page = -1,
      int pageSize = 10)
    {
    ...
    public async Task<IEnumerable<IncentiveRequestDTO>> GetIncentiveRequestsByIds(int id, int id1, string lang,
    ...
    public async Task<IEnumerable<IncentiveRequest>> GetIncentiveRequestsByOtherServiceAppId(int id, int page = -1,
      int pageSize = 10)
    {
