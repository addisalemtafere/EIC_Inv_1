...
namespace EIC.Investment.API.Controllers
{
  ...
  public class NationalitiesController : Controller
  {
    ...
    [HttpGet("ByLang/{lang}")]
    public async Task<IEnumerable<NationalDTO>> GetNationalitys(string lang, int page = -1, int pageSize = 10)
    {
      return await _nationalityRepository.GetNationalitys(lang, page, pageSize);
    }

    [HttpGet("GetDTO/{id}")]
    public async Task<NationalityDTO> GetNational(int id)
    {
      return await _nationalityRepository.GetRecord(id);
    }
