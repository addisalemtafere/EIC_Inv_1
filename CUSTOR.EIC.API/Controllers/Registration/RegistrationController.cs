...
namespace EICOnline.Controllers
{
  ...
  public class RegistrationController : Controller
  {
    ...
    public RegistrationController(ApplicationDbContext ctx, RegistrationRepository registrationRepo,
...
//                    editedRegistration.TradeNameSort = objGeez.GetSortValueU(editedRegistration.TradeNameAmh);
          editedRegistration.TradeNameSort = "";
          editedRegistration.TradeNameRegionalSort = "";
//          editedRegistration.TradeNameRegionalSort = objGeez.GetSortValueU(editedRegistration.TradeNameRegional);
          ...
          editedRegistration.BusinessNameRegionalSort =
            ""; //objGeez.GetSortValueU(editedRegistration.BusinessNameRegional);
