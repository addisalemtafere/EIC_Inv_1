...
namespace EIC.Investment.API.Controllers
{
  ...
  public class ServiceApplicationsController : Controller
  {
    ...
    public async Task<IEnumerable<ServiceAppDto>> GetServiceApplicationBillOfMaterial([FromRoute] int id, string lang)
    {
      ...
      string query1 =$@"(select IncentiveBoMRequestItemId,(Select {FieldName} from Lookup,IncentiveBoMRequestItem Where LookUpTypeId='10780' AND Lookup.LookupId=IncentiveBoMRequestItem.RejectionReason) as RejectionReason
